              ...
              <More>
                <div className="grades container--more">
                  ...
                  <div className="single--grade">
                    <div className="images--container">
                      ...
                      />
                      <img src={metacriticWord} alt="metacritic logo word" className="metacritic"/>
                    </div>
                    <div className="grade--box">
                      <span>{gameInfo.metacritic? gameInfo.metacritic : "?"}</span>
                    </div>
                  </div>
                </div>
                <div className="user--grade container--more">
                  ...
                  <div className="stars--container">
                    <div className="single--star star1" style={{backgroundImage: `url(${star1})`}} onMouseOver={handleStar1} onMouseOut={handleStar1}></div>
                    <div className="single--star star2" style={{backgroundImage: `url(${star2})`}} onMouseOver={handleStar2} onMouseOut={handleStar2}></div>
                    <div className="single--star star3" style={{backgroundImage: `url(${star3})`}} onMouseOver={handleStar3} onMouseOut={handleStar3}></div>
                    <div className="single--star star4" style={{backgroundImage: `url(${star4})`}} onMouseOver={handleStar4} onMouseOut={handleStar4}></div>
                    <div className="single--star star5" style={{backgroundImage: `url(${star5})`}} onMouseOver={handleStar5} onMouseOut={handleStar5}></div>
                  </div>
                </div>
              </More>
            )}
